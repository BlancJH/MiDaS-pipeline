...
class TransformerBlock2d(nn.Module):
    ...
    def __init__(
            ...
            stride: int = 1,
            rel_pos_cls: Callable = None,
            cfg: Optional[MaxxVitTransformerCfg] = None,
            drop_path: float = 0.,
    ):
        super().__init__()
        cfg = cfg or MaxxVitTransformerCfg()
...
class MbConvBlock(nn.Module):
    ...
    def __init__(
            ...
            cfg: Optional[MaxxVitConvCfg] = None,
            drop_path: float = 0.
    ):
        super(MbConvBlock, self).__init__()
        cfg = cfg or MaxxVitConvCfg()
...
class MaxxVitBlock(nn.Module):
    ...
    def __init__(
            ...
            dim_out: int,
            stride: int = 1,
            conv_cfg: Optional[MaxxVitConvCfg] = None,
            transformer_cfg: Optional[MaxxVitTransformerCfg] = None,
            use_nchw_attn: bool = False,  # FIXME move to cfg? True is ~20-30% faster on TPU, 5-10% slower on GPU
            drop_path: float = 0.,
    ):
        super().__init__()
        conv_cfg = conv_cfg or MaxxVitConvCfg()
        transformer_cfg = transformer_cfg or MaxxVitTransformerCfg()
